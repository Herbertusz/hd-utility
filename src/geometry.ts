 ...
 * DateTime
 *
 * @description Segédfüggvények geometriai műveletekhez
 * @requires -
 */
 ...
 */
export const isOutsideOfObject = function(rect1: Rect, rect2: Rect, pixel: number = 0): boolean {
    const intersect = getRectIntersection(rect1, rect2);
